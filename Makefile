...
SRCDIR = src
SOURCES = $(SRCDIR)/melvin.c $(SRCDIR)/main.c
TEST_SOURCES = $(SRCDIR)/melvin.c $(SRCDIR)/tests.c
PROBE_SOURCES = $(SRCDIR)/melvin.c $(SRCDIR)/graph_probe.c
LEARN_SOURCES = $(SRCDIR)/melvin.c $(SRCDIR)/melvin_learn_cli.c
DSL_SOURCES = $(SRCDIR)/melvin.c $(SRCDIR)/melvin_dsl.c
...
OUTPUT_TEST_SOURCES = $(SRCDIR)/melvin.c test_output_emission.c
PATTERN_TEST_SOURCES = $(SRCDIR)/melvin.c test_pattern_on_pattern.c
GRAPH_LEARN_SOURCES = $(SRCDIR)/melvin.c test_graph_driven_learning.c
MAINTENANCE_SOURCES = $(SRCDIR)/melvin.c test_graph_self_maintenance.c
OBJECTS = $(SOURCES:.c=.o)
TEST_OBJECTS = $(SRCDIR)/melvin.o $(SRCDIR)/tests.o
PROBE_OBJECTS = $(SRCDIR)/melvin.o $(SRCDIR)/graph_probe.o
LEARN_OBJECTS = $(SRCDIR)/melvin.o $(SRCDIR)/melvin_learn_cli.o
DSL_OBJECTS = $(SRCDIR)/melvin.o $(SRCDIR)/melvin_dsl.o
...
OUTPUT_TEST_OBJECTS = $(SRCDIR)/melvin.o test_output_emission.o
PATTERN_TEST_OBJECTS = $(SRCDIR)/melvin.o test_pattern_on_pattern.o
GRAPH_LEARN_OBJECTS = $(SRCDIR)/melvin.o test_graph_driven_learning.o
MAINTENANCE_OBJECTS = $(SRCDIR)/melvin.o test_graph_self_maintenance.o
...
$(GRAPH_LEARN_TEST_TARGET): $(GRAPH_LEARN_OBJECTS)
	$(CC) $(CFLAGS) -I$(SRCDIR) -o $(GRAPH_LEARN_TEST_TARGET) $(GRAPH_LEARN_OBJECTS)

test_graph_learn: $(GRAPH_LEARN_TEST_TARGET)

$(MAINTENANCE_TEST_TARGET): $(MAINTENANCE_OBJECTS)
	$(CC) $(CFLAGS) -I$(SRCDIR) -o $(MAINTENANCE_TEST_TARGET) $(MAINTENANCE_OBJECTS)
