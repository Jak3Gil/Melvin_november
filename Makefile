...
SRCDIR = src
SOURCES = $(SRCDIR)/melvin.c $(SRCDIR)/legacy_learning.c $(SRCDIR)/main.c
TEST_SOURCES = $(SRCDIR)/melvin.c $(SRCDIR)/legacy_learning.c $(SRCDIR)/tests.c
PROBE_SOURCES = $(SRCDIR)/melvin.c $(SRCDIR)/graph_probe.c
LEARN_SOURCES = $(SRCDIR)/melvin.c $(SRCDIR)/legacy_learning.c $(SRCDIR)/melvin_learn_cli.c
DSL_SOURCES = $(SRCDIR)/melvin.c $(SRCDIR)/legacy_learning.c $(SRCDIR)/melvin_dsl.c
...
OUTPUT_TEST_SOURCES = $(SRCDIR)/melvin.c $(SRCDIR)/legacy_learning.c test_output_emission.c
PATTERN_TEST_SOURCES = $(SRCDIR)/melvin.c $(SRCDIR)/legacy_learning.c test_pattern_on_pattern.c
GRAPH_LEARN_TEST_SOURCES = $(SRCDIR)/melvin.c $(SRCDIR)/legacy_learning.c test_graph_driven_learning.c
MAINTENANCE_TEST_SOURCES = $(SRCDIR)/melvin.c $(SRCDIR)/legacy_learning.c test_graph_self_maintenance.c
OBJECTS = $(SOURCES:.c=.o)
TEST_OBJECTS = $(SRCDIR)/melvin.o $(SRCDIR)/tests.o
PROBE_OBJECTS = $(SRCDIR)/melvin.o $(SRCDIR)/graph_probe.o
LEARN_OBJECTS = $(SRCDIR)/melvin.o $(SRCDIR)/legacy_learning.o $(SRCDIR)/melvin_learn_cli.o
DSL_OBJECTS = $(SRCDIR)/melvin.o $(SRCDIR)/legacy_learning.o $(SRCDIR)/melvin_dsl.o
...
OUTPUT_TEST_OBJECTS = $(SRCDIR)/melvin.o $(SRCDIR)/legacy_learning.o test_output_emission.o
PATTERN_TEST_OBJECTS = $(SRCDIR)/melvin.o $(SRCDIR)/legacy_learning.o test_pattern_on_pattern.o
GRAPH_LEARN_TEST_OBJECTS = $(SRCDIR)/melvin.o $(SRCDIR)/legacy_learning.o test_graph_driven_learning.o
MAINTENANCE_TEST_OBJECTS = $(SRCDIR)/melvin.o $(SRCDIR)/legacy_learning.o test_graph_self_maintenance.o
